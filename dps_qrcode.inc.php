...
include_once DISCUZ_ROOT.'./source/plugin/dps_qrcode/class_qrcode.php';
include_once DISCUZ_ROOT.'./source/plugin/dps_qrcode/class_check.php';

$config = $_G['cache']['plugin']['dps_qrcode'];
$uuid = !empty($config['uuid']) ? "?uid=".$config['uuid'] : '';
$jiathis = lang('plugin/dps_qrcode','jiathis',array('uuid' => $uuid));

$navtitle = lang('plugin/dps_qrcode', 'shortcode');
$diy = lang('plugin/dps_qrcode', 'diy');
...
if($action == 'page'){  //页面二维码
	...
	include template('dps_qrcode:float');
	...
	if(!empty($view)){//分享浏览页
		...
		$summary = $text_cut;
		$tqqtitle = lang('plugin/dps_qrcode', 'tqqtitle');
		$sharetitle = $_G[setting][bbname].$navtitle.' - '.lang('plugin/dps_qrcode', 'text');
		...
		$share = $_G['siteurl'].'plugin.php?id=dps_qrcode';//本插件URL
		$summary = lang('plugin/dps_qrcode', 'summary');
		$tqqtitle = lang('plugin/dps_qrcode', 'dtqqtitle');
		...
		if(submitcheck('codesubmit')) {  //检查是否提交
			...
			if(empty($text)){  //检查输入内容
				...
				echo 'parent.document.getElementById(\'code\').innerHTML=\'<img src="source/plugin/dps_qrcode/images/sorry.gif" />\';';
				echo 'parent.document.getElementById(\'vct\').innerHTML=\''.lang('plugin/dps_qrcode', 'error_tips').'\';';
				echo 'parent.document.getElementById(\'short\').innerHTML=\'<p class=rq>'.lang('plugin/dps_qrcode', 'error_empty').'</p>\';';
				...
				echo 'parent.document.getElementById(\'code\').innerHTML=\'<img src="source/plugin/dps_qrcode/images/sorry.gif" />\';';
				echo 'parent.document.getElementById(\'vct\').innerHTML=\''.lang('plugin/dps_qrcode', 'error_tips').'\';';
				echo 'parent.document.getElementById(\'short\').innerHTML=\'<p class=rq>'.lang('plugin/dps_qrcode', 'error_len').'</p>\';';
				echo 'parent.document.getElementById(\'down\').style.display=\'none\';';
				echo '</script>';
			}else{
				...
				if($_G['gp_command'] == 'down'){  //下载二维码
					...
					$share = $_G['siteurl'].'plugin.php?id=dps_qrcode&action='.$action.'&view='.$view;
					$summary = $text_cut;
					$tqqtitle = lang('plugin/dps_qrcode', 'tqqtitle');
					$sharetitle = $_G[setting][bbname].' - '.$navtitle.' - '.lang('plugin/dps_qrcode', 'text');
					$copyfunc = "javascript:this.select();setCopy(this.value, \'".lang('plugin/dps_qrcode', 'success_tips')."\');";
					...
					$code = '<img src="'.$long_url.'" style="border: 1px solid #FFF;padding:5px;"/>'
						.'<p style="color:#FEFEE9"><strong>'.lang('plugin/dps_qrcode', 'text').'</strong></p><p>'.$text_cut.'</p>';
					echo '<script type="text/javascript">';
					echo 'window.parent.frames.showPrompt(\'\', \'\', \'<span>'.lang('plugin/dps_qrcode', 'success_made').'</span>\', 2000);';
					echo 'parent.document.getElementById(\'vct\').innerHTML=\''.lang('plugin/dps_qrcode', 'tips').'\';';
	...
	include template('dps_qrcode:shortcode');
	...
	if(!empty($view)){//分享浏览页
		...
		$summary = $title.' | '.$url;
		$tqqtitle = lang('plugin/dps_qrcode', 'tqqtitle');
		$sharetitle = $_G[setting][bbname].$navtitle.' - '.lang('plugin/dps_qrcode', 'bookmark');
		...
		if(submitcheck('codesubmit')) {  //检查是否提交
			...
			if(empty($title) || empty($url)){  //检查输入内容
				...
				echo 'parent.document.getElementById(\'code\').innerHTML=\'<img src="source/plugin/dps_qrcode/images/sorry.gif" />\';';
				echo 'parent.document.getElementById(\'vct\').innerHTML=\''.lang('plugin/dps_qrcode', 'error_tips').'\';';
				echo 'parent.document.getElementById(\'short\').innerHTML=\'<p class=rq>'.lang('plugin/dps_qrcode', 'error_name').'</p>\';';
				echo 'parent.document.getElementById(\'down\').style.display=\'none\';';
				echo '</script>';
				...
				echo 'parent.document.getElementById(\'code\').innerHTML=\'<img src="source/plugin/dps_qrcode/images/sorry.gif" />\';';
				echo 'parent.document.getElementById(\'vct\').innerHTML=\''.lang('plugin/dps_qrcode', 'error_tips').'\';';
				echo 'parent.document.getElementById(\'short\').innerHTML=\'<p class=rq>'.lang('plugin/dps_qrcode', 'error_url').'</p>\';';
				echo 'parent.document.getElementById(\'down\').style.display=\'none\';';
				echo '</script>';
			}else{
				$text_cut = $title.'<br/>'.$url;
				...
				if($_G['gp_command'] == 'down'){  //下载二维码
					...
					$short = '<input type="text" class="px vm" onclick="'.$copyfunc.'"  style="width:150px;" readonly="readonly" tabIndex="1" value="'.$short_url.'" />';
					$code = '<img src="'.$long_url.'" style="border: 1px solid #FFF;padding:5px;"/>'
						.'<p style="color:#FEFEE9"><strong>'.lang('plugin/dps_qrcode', 'bookmark').'</strong></p><p>'.$text_cut.'</p>';
					echo '<script type="text/javascript">';
					echo 'window.parent.frames.showPrompt(\'\', \'\', \'<span>'.lang('plugin/dps_qrcode', 'success_made').'</span>\', 2000);';
					echo 'parent.document.getElementById(\'vct\').innerHTML=\''.lang('plugin/dps_qrcode', 'tips').'\';';
					echo 'parent.document.getElementById(\'down\').style.display=\'\';';
	...
	if(!empty($view)){//分享浏览页
		...
		$tqqtitle = lang('plugin/dps_qrcode', 'tqqtitle');
		$sharetitle = $_G[setting][bbname].$navtitle.' - '.lang('plugin/dps_qrcode', 'email');
		...
		if(submitcheck('codesubmit')) {  //检查是否提交
			...
			if(empty($email) || empty($subject) || empty($message)){  //检查输入内容
				...
				echo 'parent.document.getElementById(\'code\').innerHTML=\'<img src="source/plugin/dps_qrcode/images/sorry.gif" />\';';
				echo 'parent.document.getElementById(\'vct\').innerHTML=\''.lang('plugin/dps_qrcode', 'error_tips').'\';';
				echo 'parent.document.getElementById(\'short\').innerHTML=\'<p class=rq>'.lang('plugin/dps_qrcode', 'error_email').'</p>\';';
				echo 'parent.document.getElementById(\'down\').style.display=\'none\';';
				echo '</script>';
			}else{
				$text_cut = $email.'<br/>'.$subject.'<br/>'.$message;
				...
				if($_G['gp_command'] == 'down'){  //下载二维码
					...
					$short = '<input type="text" class="px vm" onclick="'.$copyfunc.'"  style="width:150px;" readonly="readonly" tabIndex="1" value="'.$short_url.'" />';
					$code = '<img src="'.$long_url.'" style="border: 1px solid #FFF;padding:5px;"/>'
						.'<p style="color:#FEFEE9"><strong>'.lang('plugin/dps_qrcode', 'email').'</strong></p><p>'.$text_cut.'</p>';
					echo '<script type="text/javascript">';
					echo 'window.parent.frames.showPrompt(\'\', \'\', \'<span>'.lang('plugin/dps_qrcode', 'success_made').'</span>\', 2000);';
					echo 'parent.document.getElementById(\'vct\').innerHTML=\''.lang('plugin/dps_qrcode', 'tips').'\';';
					echo 'parent.document.getElementById(\'down\').style.display=\'\';';
	...
	if(!empty($view)){//分享浏览页
		...
		$summary = $phone.' | '.$text;
		$tqqtitle = lang('plugin/dps_qrcode', 'tqqtitle');
		$sharetitle = $_G[setting][bbname].$navtitle.' - '.lang('plugin/dps_qrcode', 'ms');
		...
		if(submitcheck('codesubmit')) {  //检查是否提交
			...
			if(empty($phone) || empty($text)){  //检查输入内容
				...
				echo 'parent.document.getElementById(\'code\').innerHTML=\'<img src="source/plugin/dps_qrcode/images/sorry.gif" />\';';
				echo 'parent.document.getElementById(\'vct\').innerHTML=\''.lang('plugin/dps_qrcode', 'error_tips').'\';';
				echo 'parent.document.getElementById(\'short\').innerHTML=\'<p class=rq>'.lang('plugin/dps_qrcode', 'error_phone').'</p>\';';
				echo 'parent.document.getElementById(\'down\').style.display=\'none\';';
				echo '</script>';
			}else{
				$text_cut = $phone.'<br/>'.$text;
				...
				if($_G['gp_command'] == 'down'){  //下载二维码
					...
					$short = '<input type="text" class="px vm" onclick="'.$copyfunc.'"  style="width:150px;" readonly="readonly" tabIndex="1" value="'.$short_url.'" />';
					$code = '<img src="'.$long_url.'" style="border: 1px solid #FFF;padding:5px;"/>'
						.'<p style="color:#FEFEE9"><strong>'.lang('plugin/dps_qrcode', 'ms').'</strong></p><p>'.$text_cut.'</p>';
					echo '<script type="text/javascript">';
					echo 'window.parent.frames.showPrompt(\'\', \'\', \'<span>'.lang('plugin/dps_qrcode', 'success_made').'</span>\', 2000);';
					echo 'parent.document.getElementById(\'vct\').innerHTML=\''.lang('plugin/dps_qrcode', 'tips').'\';';
					echo 'parent.document.getElementById(\'down\').style.display=\'\';';
	...
	if(!empty($view)){  //分享浏览页
		...
		$tqqtitle = lang('plugin/dps_qrcode', 'tqqtitle');
		$sharetitle = $_G[setting][bbname].$navtitle.' - '.lang('plugin/dps_qrcode', 'vcard');
		...
		if(submitcheck('codesubmit')) {  //检查是否提交
			...
			if(empty($name) || empty($phone)){  //检查输入内容
				...
				if($_G['gp_command'] == 'down'){  //下载二维码
					...
					$short = '<input type="text" class="px vm" onclick="'.$copyfunc.'"  style="width:150px;" readonly="readonly" tabIndex="1" value="'.$short_url.'" />';
					$code = '<img src="'.$long_url.'" style="border: 1px solid #FFF;padding:5px;"/>'
						.'<p style="color:#FEFEE9"><strong>'.lang('plugin/dps_qrcode', 'vcard').'</strong></p><p>'.$text_cut.'</p>';
					echo '<script type="text/javascript">';
					echo 'window.parent.frames.showPrompt(\'\', \'\', \'<span>'.lang('plugin/dps_qrcode', 'success_made').'</span>\', 2000);';
					echo 'parent.document.getElementById(\'vct\').innerHTML=\''.lang('plugin/dps_qrcode', 'tips').'\';';
					echo 'parent.document.getElementById(\'down\').style.display=\'\';';
	...
	$long_url = $qr->get_link($size,$EC_level);
	$short_url = shortenGoogleUrl($long_url);
	$share = $_G['siteurl'].'plugin.php?id=dps_qrcode&action=short';//本插件URL
	$summary = lang('plugin/dps_qrcode', 'summary');
	$tqqtitle = lang('plugin/dps_qrcode', 'dtqqtitle');
	$sharetitle = $_G[setting][bbname].' - '.$navtitle.' - '.lang('plugin/dps_qrcode', 'short');
	if(submitcheck('codesubmit')) {  //检查是否提交
		...
		if(empty($long_url_s)){  //检查输入内容
			...
			$copyfunc_s = "javascript:this.select();setCopy(this.value, \'".lang('plugin/dps_qrcode', 'success_tips_s')."\');";
			$short_s = '<input type="text" class="px vm" onclick="'.$copyfunc_s.'" readonly="readonly" tabIndex="1" value="'.$short_url_s.'" />';
			$copyfunc = "javascript:this.select();setCopy(this.value, \'".lang('plugin/dps_qrcode', 'success_tips')."\');";
			$short = '<input type="text" class="px vm" onclick="'.$copyfunc.'"  style="width:150px;" readonly="readonly" tabIndex="1" value="'.$short_url.'" />';
			$code = '<img src="'.$long_url.'" style="border: 1px solid #FFF;padding:5px;"/>'
				.'<p style="color:#FEFEE9"><strong>'.lang('plugin/dps_qrcode', 'short').'</strong></p><p>'.$text_cut.'</p>';
			echo '<script type="text/javascript">';
			echo 'window.parent.frames.showPrompt(\'\', \'\', \'<span>'.lang('plugin/dps_qrcode', 'success_made_s').'</span>\', 2000);';
			echo 'parent.document.getElementById(\'vct\').innerHTML=\''.lang('plugin/dps_qrcode', 'tips').'\';';
			echo 'parent.document.getElementById(\'code\').innerHTML=\''.$code.'\';';
			echo 'parent.document.getElementById(\'short\').innerHTML=\''.$short.'\';';
	...
	$long_url = $qr->get_link($size,$EC_level);
	$short_url = shortenGoogleUrl($long_url);
	$share = $_G['siteurl'].'plugin.php?id=dps_qrcode&action=long';//本插件URL
	$summary = lang('plugin/dps_qrcode', 'summary');
	$tqqtitle = lang('plugin/dps_qrcode', 'dtqqtitle');
	$sharetitle = $_G[setting][bbname].' - '.$navtitle.' - '.lang('plugin/dps_qrcode', 'long');
	if(submitcheck('codesubmit')) {  //检查是否提交
		...
		if(empty($short_url_l)){  //检查输入内容
			...
			$copyfunc_l = "javascript:this.select();setCopy(this.value, \'".lang('plugin/dps_qrcode', 'success_tips_l')."\');";
			...
			$code = '<img src="'.$long_url.'" style="border: 1px solid #FFF;padding:5px;"/>'
				.'<p style="color:#FEFEE9"><strong>'.lang('plugin/dps_qrcode', 'short').'</strong></p><p>'.$text_cut.'</p>';
			echo '<script type="text/javascript">';
			echo 'window.parent.frames.showPrompt(\'\', \'\', \'<span>'.lang('plugin/dps_qrcode', 'success_made_l').'</span>\', 2000);';
			echo 'parent.document.getElementById(\'vct\').innerHTML=\''.lang('plugin/dps_qrcode', 'tips').'\';';
			echo 'parent.document.getElementById(\'code\').innerHTML=\''.$code.'\';';
			echo 'parent.document.getElementById(\'short\').innerHTML=\''.$short.'\';';
